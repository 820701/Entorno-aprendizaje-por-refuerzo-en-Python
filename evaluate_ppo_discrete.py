...
CHECKPOINT_PATH = r"C:\Users\josem\OneDrive\Escritorio\2025-2026\TFG\RL\tfg_rl_crane\checkpoints\crane_ppo_discrete - DEFINITIVO"
#checkpoint_path = r"checkpoints\crane_ppo_discrete_DEFINITIVO_reward9141"
...
voltajes_plot = [(a / (env.n_acciones - 1) * 2 - 1) * env.Vmax for a in actions]
...
axes[4].step(t, voltajes_plot, color='green', label='Voltaje V', where='post')
